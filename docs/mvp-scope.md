...
- Remote system and Codex probe: OS, arch, shell, current/login/interactive PATH contexts, installed Codex path and safe resolver source, `command -v codex`, `codex --version`, `~/.codex/config.toml`, API env readiness, `~/.codex/skills/`.
