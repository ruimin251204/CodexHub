...
- One batch-wide process-impact confirmation before Batch Update mutation; revalidate UID/PID/starttime/release identity before individual `SIGTERM`, and record a failed no-mutation task for every declined or unverifiable host.
